...
app = FastAPI(title='Backstract Generated APIs - coll-c2e90078e473497f8411956e1f239f2e', debug=False,
              docs_url='/sweet-shaw-f7a1efba58da11f0aa70ea8c76bcfffb81/docs',
              openapi_url='/sweet-shaw-f7a1efba58da11f0aa70ea8c76bcfffb81/openapi.json')
...
app.include_router(
    router,
    prefix='/sweet-shaw-f7a1efba58da11f0aa70ea8c76bcfffb81/api',
    tags=['APIs v1']
)
